...
import belajar_spring_restful_api.restful.model.ContactResponse;
import belajar_spring_restful_api.restful.model.CreateContactRequest;
import belajar_spring_restful_api.restful.model.UpdateContactRequest;
...
class ContactControllerTest {
    ...
    void createContactSuccess() throws Exception {
        CreateContactRequest request = new CreateContactRequest();
        request.setFirstName("Timo");
        request.setLastName("Omit");
        request.setEmail("timo@yahoo.com");
        request.setPhone("098765432112");
        ...
        mockMvc.perform(
            ...
            assertEquals("Timo", response.getData().getFirstName());
            assertEquals("Omit", response.getData().getLastName());
            assertEquals("timo@yahoo.com", response.getData().getEmail());
            assertEquals("098765432112", response.getData().getPhone());
    ...
    void updateContactSuccess() throws Exception {
        ...
        request.setLastName("Budo");
        request.setEmail("budi@yahoo.com");
        request.setPhone("081290908989");
    ...
    void searchUsingSuccess() throws Exception {
        ...
        for (int i = 0; i < 100; i++) {
            ...
            contact.setFirstName("Timo " + i);
            contact.setLastName("Omit");
            contact.setEmail("timo@example.com");
            contact.setPhone("1234567890");
            contact.setUser(user);
            contactRepository.save(contact);
